...
// WIK-128: bumped default size (h-8 → h-9), softer rounded-xl (was lg),
// slightly more horizontal padding, and a subtle shadow on the default
// variant so the primary button feels weighted instead of flat. Size
// scale shifts up uniformly: xs h-6→h-7, sm h-7→h-8, default h-8→h-9,
// lg h-9→h-10.
